...
internal class AsyncManualResetEvent {
    public bool IsSet => _tsc is { Task.IsCompleted: true };
    ...
    public AsyncManualResetEvent(bool initialState) {
        ...
        if (initialState) _tsc.TrySetResult(true);
    }
    ...
    public void Reset() {
        while (true) {
            ...
            if (!tsc.Task.IsCompleted || Interlocked.CompareExchange(ref _tsc, new TaskCompletionSource<bool>(), tsc) == tsc) return;
        }
    }
}